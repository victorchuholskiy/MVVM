...
class KeyStoreWrapper(private val context: Context,
	...
	fun aliases() = defaultKeyStore.aliases()!!

	fun getAndroidKeyStoreSymmetricKey(alias: String): SecretKey? = keyStore.getKey(alias, null) as SecretKey?

	fun getDefaultKeyStoreSymmetricKey(alias: String,
									   keyPassword: String): SecretKey? {
		return try {
	...
	fun createDefaultKeyStoreSymmetricKey(alias: String,
										  password: String) {
