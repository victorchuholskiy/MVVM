...
class EncryptionServices(context: Context) {
	...
	fun encrypt(data: String,
				keyPassword: String? = null): String {
	...
	private fun encryptWithDefaultSymmetricKey(data: String,
											   keyPassword: String): String {
		val masterKey = keyStoreWrapper.getDefaultKeyStoreSymmetricKey(MASTER_KEY, keyPassword)
		return CipherWrapper(CipherWrapper.TRANSFORMATION_SYMMETRIC).encrypt(data, masterKey, true)
	}

	private fun decryptWithDefaultSymmetricKey(data: String,
											   keyPassword: String): String {
		val masterKey = keyStoreWrapper.getDefaultKeyStoreSymmetricKey(MASTER_KEY, keyPassword)
...
//		val enumeration = keyStoreWrapper.aliases()
...
//		}
		...
		return keyStoreWrapper.aliases()
	}
